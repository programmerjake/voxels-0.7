...
const TextureAtlas
    ...
    TextureAtlas::ActivatorRailOn = {16, 0, 16, 16, 0}, TextureAtlas::BedHead = {32, 0, 16, 16, 0},
    TextureAtlas::BedFoot = {48, 0, 16, 16, 0}, TextureAtlas::BedTopSide = {64, 0, 16, 16, 0},
    ...
    TextureAtlas::BedBottomSide = {160, 0, 16, 16, 0}, TextureAtlas::BedItem = {176, 0, 16, 16, 0},
    TextureAtlas::Font8x8 = {128, 128, 128, 128, 0},
    TextureAtlas::Shockwave = {0, 128, 128, 128, 0}, TextureAtlas::Bedrock = {192, 0, 16, 16, 0},
    ...
    TextureAtlas::BirchSapling = {240, 0, 16, 16, 0}, TextureAtlas::BirchWood = {0, 16, 16, 16, 0},
    TextureAtlas::WoodEnd = {16, 16, 16, 16, 0}, TextureAtlas::BlazePowder = {32, 16, 16, 16, 0},
    TextureAtlas::BlazeRod = {48, 16, 16, 16, 0}, TextureAtlas::Bone = {64, 16, 16, 16, 0},
    TextureAtlas::BoneMeal = {80, 16, 16, 16, 0}, TextureAtlas::Bow = {96, 16, 16, 16, 0},
    TextureAtlas::BrownMushroom = {112, 16, 16, 16, 0}, TextureAtlas::Bucket = {128, 16, 16, 16, 0},
    ...
    TextureAtlas::Charcoal = {368, 112, 16, 16, 0}, TextureAtlas::ChestSide = {208, 16, 16, 16, 0},
    TextureAtlas::ChestTop = {224, 16, 16, 16, 0}, TextureAtlas::ChestFront = {240, 16, 16, 16, 0},
    TextureAtlas::Cobblestone = {0, 32, 16, 16, 0}, TextureAtlas::Coal = {16, 32, 16, 16, 0},
    TextureAtlas::CoalOre = {32, 32, 16, 16, 0}, TextureAtlas::CocoaSmallSide = {48, 32, 16, 16, 0},
    ...
    TextureAtlas::CocoaBeans = {192, 32, 16, 16, 0}, TextureAtlas::DeadBush = {208, 32, 16, 16, 0},
    TextureAtlas::DandelionYellow = {224, 32, 16, 16, 0},
    TextureAtlas::Dandelion = {240, 32, 16, 16, 0}, TextureAtlas::CyanDye = {0, 48, 16, 16, 0},
    TextureAtlas::Delete0 = {16, 48, 16, 16, 0}, TextureAtlas::Delete1 = {32, 48, 16, 16, 0},
    TextureAtlas::Delete2 = {48, 48, 16, 16, 0}, TextureAtlas::Delete3 = {64, 48, 16, 16, 0},
    TextureAtlas::Delete4 = {80, 48, 16, 16, 0}, TextureAtlas::Delete5 = {96, 48, 16, 16, 0},
    TextureAtlas::Delete6 = {112, 48, 16, 16, 0}, TextureAtlas::Delete7 = {128, 48, 16, 16, 0},
    TextureAtlas::Delete8 = {144, 48, 16, 16, 0}, TextureAtlas::Delete9 = {160, 48, 16, 16, 0},
    TextureAtlas::DetectorRailOff = {176, 48, 16, 16, 0},
    TextureAtlas::DetectorRailOn = {192, 48, 16, 16, 0},
    TextureAtlas::Diamond = {208, 48, 16, 16, 0}, TextureAtlas::DiamondAxe = {224, 48, 16, 16, 0},
    TextureAtlas::DiamondHoe = {240, 48, 16, 16, 0}, TextureAtlas::DiamondOre = {0, 64, 16, 16, 0},
    TextureAtlas::DiamondPickaxe = {16, 64, 16, 16, 0},
    TextureAtlas::DiamondShovel = {32, 64, 16, 16, 0}, TextureAtlas::Dirt = {48, 64, 16, 16, 0},
    TextureAtlas::DirtMask = {64, 64, 16, 16, 0}, TextureAtlas::DispenserSide = {80, 64, 16, 16, 0},
    ...
    TextureAtlas::Emerald = {160, 48, 16, 16, 0}, TextureAtlas::EmeraldOre = {176, 64, 16, 16, 0},
    ...
    TextureAtlas::FarmlandTop = {48, 80, 16, 16, 0}, TextureAtlas::Fire0 = {496, 256, 16, 32, 0},
    TextureAtlas::Fire1 = {480, 256, 16, 32, 0}, TextureAtlas::Fire2 = {464, 256, 16, 32, 0},
    TextureAtlas::Fire3 = {448, 256, 16, 32, 0}, TextureAtlas::Fire4 = {432, 256, 16, 32, 0},
    TextureAtlas::Fire5 = {416, 256, 16, 32, 0}, TextureAtlas::Fire6 = {400, 256, 16, 32, 0},
    TextureAtlas::Fire7 = {384, 256, 16, 32, 0}, TextureAtlas::Fire8 = {368, 256, 16, 32, 0},
    TextureAtlas::Fire9 = {352, 256, 16, 32, 0}, TextureAtlas::Fire10 = {336, 256, 16, 32, 0},
    TextureAtlas::Fire11 = {320, 256, 16, 32, 0}, TextureAtlas::Fire12 = {304, 256, 16, 32, 0},
    TextureAtlas::Fire13 = {288, 256, 16, 32, 0}, TextureAtlas::Fire14 = {272, 256, 16, 32, 0},
    TextureAtlas::Fire15 = {256, 256, 16, 32, 0}, TextureAtlas::Fire16 = {240, 256, 16, 32, 0},
    TextureAtlas::Fire17 = {224, 256, 16, 32, 0}, TextureAtlas::Fire18 = {208, 256, 16, 32, 0},
    TextureAtlas::Fire19 = {192, 256, 16, 32, 0}, TextureAtlas::Fire20 = {176, 256, 16, 32, 0},
    TextureAtlas::Fire21 = {160, 256, 16, 32, 0}, TextureAtlas::Fire22 = {144, 256, 16, 32, 0},
    TextureAtlas::Fire23 = {128, 256, 16, 32, 0}, TextureAtlas::Fire24 = {112, 256, 16, 32, 0},
    TextureAtlas::Fire25 = {96, 256, 16, 32, 0}, TextureAtlas::Fire26 = {80, 256, 16, 32, 0},
    TextureAtlas::Fire27 = {64, 256, 16, 32, 0}, TextureAtlas::Fire28 = {48, 256, 16, 32, 0},
    TextureAtlas::Fire29 = {32, 256, 16, 32, 0}, TextureAtlas::Fire30 = {16, 256, 16, 32, 0},
    TextureAtlas::Fire31 = {0, 256, 16, 32, 0}, TextureAtlas::Flint = {192, 80, 16, 16, 0},
    ...
    TextureAtlas::WorkBenchSide1 = {48, 96, 16, 16, 0}, TextureAtlas::Glass = {64, 96, 16, 16, 0},
    TextureAtlas::GoldAxe = {80, 96, 16, 16, 0}, TextureAtlas::GoldHoe = {96, 96, 16, 16, 0},
    TextureAtlas::GoldIngot = {112, 96, 16, 16, 0}, TextureAtlas::GoldOre = {128, 96, 16, 16, 0},
    TextureAtlas::GoldPickaxe = {144, 96, 16, 16, 0},
    TextureAtlas::GoldShovel = {160, 96, 16, 16, 0}, TextureAtlas::GrassMask = {176, 96, 16, 16, 0},
    TextureAtlas::GrassTop = {192, 96, 16, 16, 0}, TextureAtlas::Gravel = {208, 96, 16, 16, 0},
    TextureAtlas::GrayDye = {224, 96, 16, 16, 0}, TextureAtlas::Gunpowder = {240, 96, 16, 16, 0},
    ...
    TextureAtlas::HotBarBox = {256, 236, 20, 20, 0}, TextureAtlas::InkSac = {96, 112, 16, 16, 0},
    TextureAtlas::IronAxe = {112, 112, 16, 16, 0}, TextureAtlas::IronHoe = {128, 112, 16, 16, 0},
    TextureAtlas::IronIngot = {144, 112, 16, 16, 0}, TextureAtlas::IronOre = {160, 112, 16, 16, 0},
    ...
    TextureAtlas::JungleWood = {256, 0, 16, 16, 0}, TextureAtlas::Ladder = {272, 0, 16, 16, 0},
    TextureAtlas::LapisLazuli = {288, 0, 16, 16, 0},
    TextureAtlas::LapisLazuliOre = {304, 0, 16, 16, 0},
    TextureAtlas::WheatItem = {320, 0, 16, 16, 0}, TextureAtlas::LavaBucket = {336, 0, 16, 16, 0},
    ...
    TextureAtlas::LightGrayDye = {400, 0, 16, 16, 0}, TextureAtlas::LimeDye = {416, 0, 16, 16, 0},
    ...
    TextureAtlas::MobSpawner = {352, 16, 16, 16, 0}, TextureAtlas::OrangeDye = {368, 16, 16, 16, 0},
    ...
    TextureAtlas::WaterSide5 = {464, 16, 16, 16, 0}, TextureAtlas::Obsidian = {480, 16, 16, 16, 0},
    ...
    TextureAtlas::ParticleFire1 = {328, 128, 8, 8, 0}, TextureAtlas::PinkDye = {496, 16, 16, 16, 0},
    TextureAtlas::PinkStone = {256, 16, 16, 16, 0},
    TextureAtlas::PistonShaft = {276, 244, 2, 12, 0}, TextureAtlas::OakPlank = {272, 32, 16, 16, 0},
    TextureAtlas::PoweredRailOff = {288, 32, 16, 16, 0},
    TextureAtlas::PoweredRailOn = {304, 32, 16, 16, 0},
    TextureAtlas::PurpleDye = {320, 32, 16, 16, 0},
    TextureAtlas::PurplePortal = {336, 32, 16, 16, 0}, TextureAtlas::Quartz = {352, 32, 16, 16, 0},
    TextureAtlas::Rail = {368, 32, 16, 16, 0}, TextureAtlas::RailCurve = {384, 32, 16, 16, 0},
    ...
    TextureAtlas::Rose = {448, 48, 16, 16, 0}, TextureAtlas::RoseRed = {464, 48, 16, 16, 0},
    TextureAtlas::Sand = {480, 48, 16, 16, 0}, TextureAtlas::OakSapling = {496, 48, 16, 16, 0},
    TextureAtlas::WheatSeeds = {256, 64, 16, 16, 0}, TextureAtlas::Shears = {272, 64, 16, 16, 0},
    TextureAtlas::Slime = {288, 64, 16, 16, 0}, TextureAtlas::Snow = {304, 64, 16, 16, 0},
    TextureAtlas::SnowBall = {320, 64, 16, 16, 0}, TextureAtlas::SnowGrass = {336, 64, 16, 16, 0},
    ...
    TextureAtlas::SpruceWood = {400, 64, 16, 16, 0}, TextureAtlas::Stick = {416, 64, 16, 16, 0},
    TextureAtlas::Stone = {432, 64, 16, 16, 0}, TextureAtlas::StoneAxe = {448, 64, 16, 16, 0},
    ...
    TextureAtlas::StringItem = {304, 80, 16, 16, 0}, TextureAtlas::TallGrass = {320, 80, 16, 16, 0},
    TextureAtlas::LavaSide0 = {336, 80, 16, 16, 0}, TextureAtlas::LavaSide1 = {352, 80, 16, 16, 0},
    TextureAtlas::LavaSide2 = {368, 80, 16, 16, 0}, TextureAtlas::LavaSide3 = {384, 80, 16, 16, 0},
    TextureAtlas::LavaSide4 = {400, 80, 16, 16, 0}, TextureAtlas::LavaSide5 = {416, 80, 16, 16, 0},
    TextureAtlas::TNTSide = {432, 80, 16, 16, 0}, TextureAtlas::TNTTop = {448, 80, 16, 16, 0},
    TextureAtlas::TNTBottom = {464, 80, 16, 16, 0}, TextureAtlas::Blank = {480, 80, 16, 16, 0},
    TextureAtlas::TorchSide = {496, 80, 16, 16, 0}, TextureAtlas::TorchTop = {503, 86, 2, 2, 0},
    TextureAtlas::TorchBottom = {503, 94, 2, 2, 0}, TextureAtlas::Vines = {256, 96, 16, 16, 0},
    TextureAtlas::WaterBucket = {272, 96, 16, 16, 0},
    TextureAtlas::SpiderWeb = {288, 96, 16, 16, 0},
    TextureAtlas::WetFarmland = {304, 96, 16, 16, 0}, TextureAtlas::Wheat0 = {320, 96, 16, 16, 0},
    TextureAtlas::Wheat1 = {336, 96, 16, 16, 0}, TextureAtlas::Wheat2 = {352, 96, 16, 16, 0},
    TextureAtlas::Wheat3 = {368, 96, 16, 16, 0}, TextureAtlas::Wheat4 = {384, 96, 16, 16, 0},
    TextureAtlas::Wheat5 = {400, 96, 16, 16, 0}, TextureAtlas::Wheat6 = {416, 96, 16, 16, 0},
    TextureAtlas::Wheat7 = {432, 96, 16, 16, 0}, TextureAtlas::OakWood = {448, 96, 16, 16, 0},
    TextureAtlas::WoodAxe = {464, 96, 16, 16, 0}, TextureAtlas::WoodHoe = {480, 96, 16, 16, 0},
    ...
    TextureAtlas::WoodShovel = {272, 112, 16, 16, 0}, TextureAtlas::Wool = {288, 112, 16, 16, 0},
    ...
    TextureAtlas::ChestUI = {0, 105, 170, 151, 3}, TextureAtlas::CreativeUI = {0, 105, 170, 151, 4},
    TextureAtlas::DispenserDropperUI = {0, 105, 170, 151, 5},
    TextureAtlas::FurnaceUI = {0, 105, 170, 151, 6}, TextureAtlas::HopperUI = {0, 105, 170, 151, 7},
    ...
    TextureAtlas::DamageBarGray = {259, 222, 1, 2, 0}, TextureAtlas::Sun = {320, 224, 32, 32, 0},
    TextureAtlas::Moon0 = {352, 240, 16, 16, 0}, TextureAtlas::Moon1 = {368, 240, 16, 16, 0},
    TextureAtlas::Moon2 = {384, 240, 16, 16, 0}, TextureAtlas::Moon3 = {400, 240, 16, 16, 0},
    TextureAtlas::Moon4 = {416, 240, 16, 16, 0}, TextureAtlas::Moon5 = {432, 240, 16, 16, 0},
    TextureAtlas::Moon6 = {448, 240, 16, 16, 0}, TextureAtlas::Moon7 = {464, 240, 16, 16, 0};
