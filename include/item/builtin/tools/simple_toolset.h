...
protected:
    ...
    public:
        SimplePickaxeRecipe(ItemDescriptorPointer itemDescriptor, Item recipeMaterial, unsigned outputCount)
    ...
    SimplePickaxe(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue)
        : Pickaxe(L"builtin.tools.simple_pickaxe(toolset=" + toolsetName + L")", td), toolLevel(toolLevel), mineDurationFactor(mineDurationFactor), recipe(nullptr), maxDamageValue(maxDamageValue)
    {

    }
public:
    SimplePickaxe(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue, Item recipeMaterial)
...
protected:
    ...
    public:
        SimpleAxeRecipe(ItemDescriptorPointer itemDescriptor, Item recipeMaterial, unsigned outputCount)
            : PatternRecipe(checked_array<Item, 2 * 3>
            {
                recipeMaterial, recipeMaterial,
                recipeMaterial, Item(Items::builtin::Stick::descriptor()),
                Item(), Item(Items::builtin::Stick::descriptor()),
            }), outputCount(outputCount), itemDescriptor(itemDescriptor)
        {
        }
    };
    SimpleAxe(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue)
        : Axe(L"builtin.tools.simple_axe(toolset=" + toolsetName + L")", td), toolLevel(toolLevel), mineDurationFactor(mineDurationFactor), recipe(nullptr), maxDamageValue(maxDamageValue)
    {

    }
public:
    SimpleAxe(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue, Item recipeMaterial)
...
protected:
    ...
    public:
        SimpleShovelRecipe(ItemDescriptorPointer itemDescriptor, Item recipeMaterial, unsigned outputCount)
    ...
    SimpleShovel(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue)
        : Shovel(L"builtin.tools.simple_shovel(toolset=" + toolsetName + L")", td), toolLevel(toolLevel), mineDurationFactor(mineDurationFactor), recipe(nullptr), maxDamageValue(maxDamageValue)
    {

    }
public:
    SimpleShovel(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue, Item recipeMaterial)
...
protected:
    ...
    public:
        SimpleHoeRecipe(ItemDescriptorPointer itemDescriptor, Item recipeMaterial, unsigned outputCount)
            : PatternRecipe(checked_array<Item, 2 * 3>
            {
                recipeMaterial, recipeMaterial,
                Item(), Item(Items::builtin::Stick::descriptor()),
    ...
    SimpleHoe(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue)
        : Hoe(L"builtin.tools.simple_hoe(toolset=" + toolsetName + L")", td), toolLevel(toolLevel), mineDurationFactor(mineDurationFactor), recipe(nullptr), maxDamageValue(maxDamageValue)
    {

    }
public:
    SimpleHoe(std::wstring toolsetName, TextureDescriptor td, ToolLevel toolLevel, float mineDurationFactor, unsigned maxDamageValue, Item recipeMaterial)
...
protected:
    ...
    {
        if(td)
            return new SimplePickaxe(toolsetName, td, toolLevel, mineDurationFactor, maxDamage, recipeMaterial);
        return nullptr;
    }
    ...
    {
        if(td)
            return new SimpleAxe(toolsetName, td, toolLevel, mineDurationFactor, maxDamage, recipeMaterial);
        return nullptr;
    }
    ...
    {
        if(td)
            return new SimpleShovel(toolsetName, td, toolLevel, mineDurationFactor, maxDamage, recipeMaterial);
        return nullptr;
    }
    ...
    {
        if(td)
            return new SimpleHoe(toolsetName, td, toolLevel, mineDurationFactor, maxDamage, recipeMaterial);
        return nullptr;
    }
public:
        ...
        hoe()
    {
        ...
        shovel = makeShovel(toolsetName, toolLevel, mineDurationFactor, maxDamage, recipeMaterial, shovelTexture);
        hoe = makeHoe(toolsetName, toolLevel, mineDurationFactor, maxDamage, recipeMaterial, hoeTexture);
    }
