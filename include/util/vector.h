...
constexpr inline VectorF elementwiseMax(const VectorF &a, const VectorF &b)
{
    return VectorF(a.x < b.x ? b.x : a.x, a.y < b.y ? b.y : a.y, a.z < b.z ? b.z : a.z);
}

constexpr inline VectorF elementwiseMin(const VectorF &a, const VectorF &b)
{
    return VectorF(a.x < b.x ? a.x : b.x, a.y < b.y ? a.y : b.y, a.z < b.z ? a.z : b.z);
}

constexpr inline VectorI elementwiseMax(const VectorI &a, const VectorI &b)
{
    return VectorI(a.x < b.x ? b.x : a.x, a.y < b.y ? b.y : a.y, a.z < b.z ? b.z : a.z);
}

constexpr inline VectorI elementwiseMin(const VectorI &a, const VectorI &b)
{
    return VectorI(a.x < b.x ? a.x : b.x, a.y < b.y ? a.y : b.y, a.z < b.z ? a.z : b.z);
}
